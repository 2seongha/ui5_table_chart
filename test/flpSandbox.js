		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FI Document List",
									"targetURL": "#zc6fi1401modzc6fi1401-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc6fi1401modzc6fi1401-display": {
								"semanticObject": "zc6fi1401modzc6fi1401",
								"action": "display",
								"description": "FI Document List",
								"title": "FI Document List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc6.fi1401.mod.zc6fi1401",
									"url": sap.ui.require.toUrl("zc6/fi1401/mod/zc6fi1401")
								}
							}
						}
					}
